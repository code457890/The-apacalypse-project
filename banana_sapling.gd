...
var timer: float = 0.0
@onready var tree = load("res://bananatreeeeeeeeeeeee.tscn")
...
func _process(delta: float) -> void:
	...
	if timer >= 10.0:
		...
		y.set_script(preload("res://banana_tree.gd"))
		y.max_health = 24
		y.loot_scene = preload("res://ground_item_gravity.tscn")
		y.log_data = preload("res://strong_wood.tres")
		y.leaf_data = preload("res://banana_leaf.tres")
